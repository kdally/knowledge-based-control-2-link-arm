% Code developped on MATLAB 2019_b by Group 61
% Based on the initial code for course SC42050's practical assignment 
...
% Train on rotational velocitites from 70 to 80 deg/s
rot_vel = [70:1:80];
...
% Create ANN with hidden layer of 30 neurons
...
% Give some initial weights to network with the Nguyen-Widrow initialization algorithm
% Random initial weights evenley spread in each layer
net = init(net);
